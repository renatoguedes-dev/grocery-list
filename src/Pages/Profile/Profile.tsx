...
const Profile = () => {
  ...
  const confNewPwParagraphErrorRef = useRef<HTMLParagraphElement | null>(null);
    ...
    <div className="container">
      <main className={`${style.mainContainer} mainContainer`}>
        ...
        <div className={style.personalDataDiv}>
          ...
          {isChangePasswordActive && !showResponseDiv && (
            <form className={style.changePasswordForm} onSubmit={handleSubmit}>
              <div className={style.inputParent}>
                ...
                <p className={style.passwordError} ref={oldPwParagraphErrorRef}>
              ...
              <div className={style.inputParent}>
                ...
                <p className={style.passwordError} ref={newPwParagraphErrorRef}>
